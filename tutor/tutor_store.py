...
class TutorStore:
    ...
    def load(self) -> list[TutorEntry]:
        ...
        try:
            ...
            return [TutorEntry(line_idx=e['line_idx'], raw=e['raw'], explanation=e['explanation']) for e in data]
    ...
    def _write(self, entries: list[TutorEntry]) -> None:
        ...
        data = [{'line_idx': e.line_idx, 'raw': e.raw, 'explanation': e.explanation} for e in entries]
