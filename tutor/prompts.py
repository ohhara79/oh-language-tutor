...
def build_base_system_prompt(
    ...
    return (
        ...
        '- Use IPA in square brackets for languages where spelling and sound diverge\n'
        '  (English, French, Russian, Arabic, Thai, …),\n'
        '  e.g. accept [əkˈsɛpt] → 받아들이다.\n'  # noqa: RUF001 — U+02C8 is the IPA primary-stress mark
        '- For Japanese, use hiragana in parentheses (not IPA),\n'
        '  e.g. 受け入れる (うけいれる) → 받아들이다.\n'
        ...
        '  (Korean Hangul, Spanish, Italian, Indonesian, …), omit the bracket entirely\n'
        '  — the word itself already conveys pronunciation.\n'
        '\n'
        'Level guidance:\n'
