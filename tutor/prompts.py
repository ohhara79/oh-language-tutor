...
_VARIANT_CLAUSE_KOREAN = (
    ...
    'Hangul as the base or hanja inside <rt>. Per-span behaviour: '
    ...
    '— mixed script is the traditional Korean convention. NEVER wrap '
    ...
    'above each hanja as the <rt>). Omit the entire row only when no '
