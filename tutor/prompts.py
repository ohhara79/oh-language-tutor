...
def build_base_system_prompt(
    ...
    return (
        ...
        'most characters coincide. Then wrap each Han character in the '
        'rewrite with per-character <ruby> pinyin per the Mandarin Chinese '
        'pronunciation rule below. For Japanese: copy the kyūjitai (旧字体) '
